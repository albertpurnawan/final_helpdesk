              ...
              child: Column(
                children: [
                  ...
                  CarouselSlider(
                    ...
                    items: _dataIssue.map((i) {
                      return ListView.builder(
                        itemCount: _dataIssue.length,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(_dataIssue[0]['TicketNumber'],
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Helpdesk Username:",
                                        style: GoogleFonts.inter(
                                            fontSize: 15,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text(_dataIssue[0]['HelpdeskUsername'],
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Helpdesk Name:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text(_dataIssue[0]['HelpdeskName'],
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    const SizedBox(height: 10),
                                    Text(
                                        (_dataIssue[0]['HelpdeskResponseDate']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("PIC Closd Date:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['PICCloseDate']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Duration by helpdesk:",
                                        style: GoogleFonts.inter(
                                            fontSize: 15,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['Durationbyhelpdesk']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Durationby PIC:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['DurationbyPIC']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Communication By:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['CommunicationBy']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Support Category:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['SupportCategory']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("SubCategory 1:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['SubCategory1']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("SubCategory 2:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['SubCategory2']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Corrective Action:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['CorrectiveAction']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
                                    ...
                                    Text("Rejected Notes:",
                                        style: GoogleFonts.inter(
                                            ...
                                            fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 10),
                                    Text((_dataIssue[0]['RejectedNotes']),
                                        style: GoogleFonts.inter(
                                            fontSize: 12,
                                            color: primaryColor,
                                            fontWeight: FontWeight.bold)),
